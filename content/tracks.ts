...
export const tracks: Track[] = [
  {
    ...
    seoDescription:
      'Sing 原创《行走》以独立摇滚和城市叙事写恐惧、悲伤与继续前行的力量，是 Sing Walking 项目的精神入口。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《师傅，到市区多少钱》用城市民谣叙事记录南方雨天、漂泊青春与理想困境，是 Sing 写给城市生活的真实切片。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《空》以凌晨、红酒、沙发和儿时记忆搭建氛围空间，呈现 Sing 更内省、缓慢、梦境化的一面。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《雨静.伤》以古风意象写相思、月光与心伤，把雨声、泪光和岁月感凝成 Sing 的东方抒情作品。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《时间里的故事》记录时间流逝、快乐与无奈共存的日常人生，是 Sing 写给成长、回忆和希望的抒情作品。',
    story: {
  ...
  },
  {
    ...
    genre: ['旅行民谣', '抒情', '回忆'],
    featured: false,
    note: '以拉萨清晨、远望布达拉宫和屋顶等待日出的旅行记忆为核心，像一首写给旅途、也写给旧时光的歌。',
    lyrics:
      '在一次美好的旅行中\n在这座最高的城市里\n我会牵着你的手经过\n那一条条悠长的巷子口\n\n爬过屋顶等待着日出\n去留住每一次的感动\n我们穿过一座座高山\n只为旅途最美的风景\n\n那些欢乐美好的时光\n那些曾经悲伤的泪水\n那些阳光明媚的早晨\n那样灿烂美好的一天',
    excerpt: '旅行带来的不只是风景，而是很多年后回头看仍会发光的那段时光。',
    seoDescription:
      '《最美的时光》以拉萨旅行、布达拉宫、日出和屋顶记忆为线索，唱出多年后仍会发光的青春与旅途。',
    story: {
      background: '明显带着拉萨旅行记忆，远处的布达拉宫、清晨的山线、屋顶和旧客栈都像真实存在过。',
      trigger: '许多年后重新回到同一个地方，过去的感动、失落和日出前的等待一起被重新唤醒。',
      expression: '写“最美的时光”，其实也是在写已经过去却仍不愿放下的东西，让风景成为回忆的入口。',
    },
    credits: {
      compose: '邢孔攀（Sing）',
      arrange: '邢孔攀（Sing）',
  ...
  },
  {
    ...
    seoDescription:
      '《如果》是一首轻快明亮的 Sing 原创情歌，用简单直接的语言写心动、微笑和愿意陪你到老的确认。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《妈妈别哭》是 Sing 写给母亲的真诚作品，以亲情、电子音乐元素和抒情表达唱出心疼、感谢与坚强。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《回归》以独立摇滚气质写城市忧伤、理想遗忘与重新出发，是 Sing 从混乱中返回自己的创作记录。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《内心的光芒》用抒情摇滚和治愈气质写悲伤、慌张与远行之后仍然存在的内在力量。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《听见悲伤》以雨声、等待、滴答时间和回忆为核心，呈现 Sing 温柔而深邃的雨夜抒情。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《You are beautiful》融合中文叙事与英文副歌，以北方晚风、城市灯火和圣诞夜写远方思念。',
    story: {
  ...
  },
  {
    ...
    seoDescription:
      '《黑暗中的挣扎》是 Sing 情绪最锋利的另类摇滚作品之一，直接书写困境、怒火、求救与挣脱。',
    story: {
